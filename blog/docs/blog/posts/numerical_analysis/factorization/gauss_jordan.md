...
!!! info "Detalles para la implementación"

    - Las columnas se tienen que eliminar en orden de izquierda a derecha.
    - La cantidad de operaciones entre filas necesarias siempre va a ser la cantidad de elementos debajo de la diagonal principal.

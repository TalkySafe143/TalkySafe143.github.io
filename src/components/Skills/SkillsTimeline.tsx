...
import {
    SiApachekafka,
    SiArduino, SiAstro, SiCplusplus, SiCypress, SiDeno, SiDotnet,
    SiExpress, SiJest,
    SiJsonwebtokens, SiJupyter,
    SiMqtt, SiNestjs, SiPassport,
    SiPug, SiRabbitmq,
    SiSailsdotjs,
    SiSocketdotio, SiSpring, SiSwagger,
    SiTypescript
} from "react-icons/si";
            ...
            (
                <TimelineMark
                    ...
                    description={
                        (
                            <p>
                                Starting in high-school, I take a free <a
                                    href="https://pll.harvard.edu/course/cs50-introduction-computer-science"
                                    className="text-blue-600"
                                    target="_blank"
                                >CS50 bootcamp</a> and learn some web fundamentals with Python/Django included.
                            </p>
                        )
                    }
                    icons={
            ...
            (
                <TimelineMark
                    ...
                    description={
                        (
                            <p>
                                 I took a course at <a href="https://www.sena.edu.co/es-co/Paginas/default.aspx" target="_blank" className="text-blue-600">SENA</a> where I learned C++.
                            </p>
                        )
                    }
                    icons={
            ...
            (
                <TimelineMark
                    ...
                    description={
                        (
                            <p>
                                I started a learning path at <a
                                href="https://platzi.com"
                                target="_blank"
                                className="text-blue-600"
                            >Platzi</a> on backend development with JavaScript, learned GIT, went a little deeper into the JavaScript base and started to get familiar with terminal.
                            </p>
                        )
                    }
                    icons={
            ...
            (
                <TimelineMark
                    ...
                    description={
                        (
                            <p>
                                The first semester of college I was admitted to a scholarship at Oracle Next Education (<a href="https://www.oracle.com/co/education/oracle-next-education/" target="_blank" className="text-blue-600">ONE</a>) where I learned Java, deepened my knowledge in web development and discovered Jupyter Notebooks and their use for data analytics with Python.
                            </p>
                        )
                    }
                    icons={
